...
ANDROID_RESOURCE_FILE="${SAMPLE_ROOT}/sample-apps/android/src/androidMain/assets/plugin.pwasm"
...
PLUGIN_OUTPUT_FILE="$(build_plugin_pwasm "$COMPILE_OUTPUT_ROOT" "$WASMTIME_DIR" "android plugin artifact")"
