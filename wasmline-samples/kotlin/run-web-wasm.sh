...
Assemble the sample plugin, copy its wasm artifact into the web resources directory, and start the Wasm browser dev server.
...
PLUGIN_WASM_FILE="$(build_plugin_wasm "web Wasm plugin artifact")"
