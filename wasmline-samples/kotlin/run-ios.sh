...
ensure_ios_prerequisites() {
    ...
    local _wasmtime_ver
    _wasmtime_ver=$(python3 -c "import json;print('release-v'+json.load(open('${REPO_ROOT}/scripts/versions.json'))['versions']['wasmtime_version'])" 2>/dev/null || echo "release-v48.0.1")
