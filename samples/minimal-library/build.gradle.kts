...
layout.buildDirectory.set(rootProject.layout.buildDirectory.dir("minimal-library"))

kotlin {
    jvmToolchain(rootProject.extra["jbrVersion"] as Int)
    android {
        namespace = "crow.wasmline.samples.minimal.library"
...
// This library is not an executable, but Compose creates a desktopRun
