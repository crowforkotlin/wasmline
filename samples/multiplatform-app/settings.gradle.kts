...
rootProject.name = "wasmline-multiplatform-app"
...
project(":sample-plugin").projectDir = file("plugins/kotlin-service")
project(":sample-component-plugin").projectDir = file("plugins/kotlin-component-service")
project(":sample-component-export-plugin").projectDir = file("plugins/kotlin-component-export")
project(":sample-raw-export-plugin").projectDir = file("plugins/raw-export")
project(":sample-component-fixture").projectDir = file("plugins/component-package")
