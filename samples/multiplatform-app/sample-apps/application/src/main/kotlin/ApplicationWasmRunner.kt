...
private const val MANIFEST_URL_PROPERTY = "wasmline.manifest.url"
...
private fun resolveRemoteManifestUrl(): String? = System.getProperty(MANIFEST_URL_PROPERTY)?.takeIf(String::isNotBlank)
    ?: System.getenv(MANIFEST_URL_ENVIRONMENT)?.takeIf(String::isNotBlank)

private fun extractBundledPackage(): File {
    val classLoader = Thread.currentThread().contextClassLoader
    val manifestResource = "$BUNDLED_PACKAGE_ROOT/manifest.wlm"
    ...
    paths.forEach { relativePath ->
        ...
        val resource = "$BUNDLED_PACKAGE_ROOT/$safePath"
