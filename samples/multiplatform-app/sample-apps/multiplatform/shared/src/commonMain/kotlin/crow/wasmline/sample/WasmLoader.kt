...
internal class WasmSampleRunner(private val assetRefresher: AssetRefresher) {
    ...
    private fun runCoreService(runtime: Wasmline, input: PlatformBean, log: (String) -> Unit): SampleInvocation {
    ...
    private fun runRaw(runtime: Wasmline, value: Int, log: (String) -> Unit): SampleInvocation {
    ...
    private fun runComponentService(runtime: Wasmline, content: String, log: (String) -> Unit): SampleInvocation {
    ...
    private fun runComponentFixture(runtime: Wasmline, content: String, log: (String) -> Unit): SampleInvocation {
    ...
    private fun runComponentExport(runtime: Wasmline, value: Int, log: (String) -> Unit): SampleInvocation {
...
private fun String.fileName(): String = substringAfterLast('/').substringAfterLast('\\').ifBlank { "—" }
