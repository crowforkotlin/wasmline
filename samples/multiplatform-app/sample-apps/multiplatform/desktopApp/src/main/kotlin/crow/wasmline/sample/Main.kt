...
private const val CORE_SERVICE_PACKAGE_ROOT = "wasmline-packages/core-service"
private const val RAW_EXPORT_PACKAGE_ROOT = "wasmline-packages/raw-export"
private const val COMPONENT_SERVICE_PACKAGE_ROOT = "wasmline-packages/component-service"
private const val COMPONENT_EXPORT_PACKAGE_ROOT = "wasmline-packages/component-export"
...
private fun configuredSampleArtifacts(packages: Map<WasmSampleMode, BundledPluginPackage>): SampleArtifacts = SampleArtifacts(
...
@Composable
fun DecoratedWindowScope.DesktopTitleBar(title: String = "Wasmline") {
    TitleBar {
        Text(
            text = title,
...
private data class BundledPluginPackage(val directory: File, val manifestFile: File, val resourcePaths: Map<String, String>)
...
private fun extractPluginPackagesToTemp(): Map<WasmSampleMode, BundledPluginPackage> = mapOf(
    WasmSampleMode.CORE_SERVICE to extractPluginPackageToTemp(WasmSampleMode.CORE_SERVICE, CORE_SERVICE_PACKAGE_ROOT),
    WasmSampleMode.RAW_EXPORT to extractPluginPackageToTemp(WasmSampleMode.RAW_EXPORT, RAW_EXPORT_PACKAGE_ROOT),
    WasmSampleMode.COMPONENT_SERVICE to extractPluginPackageToTemp(
        WasmSampleMode.COMPONENT_SERVICE,
        COMPONENT_SERVICE_PACKAGE_ROOT,
    ),
    WasmSampleMode.COMPONENT_EXPORT to extractPluginPackageToTemp(
        WasmSampleMode.COMPONENT_EXPORT,
        COMPONENT_EXPORT_PACKAGE_ROOT,
    ),
)
 ...
 */
@OptIn(ExperimentalResourceApi::class)
private class DesktopAssetRefresher(pluginPackages: Collection<BundledPluginPackage>) : AssetRefresher {
