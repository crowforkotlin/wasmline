...
source "${SAMPLE_ROOT}/../build-support/configure-component.sh"

usage() {
    cat <<'EOF'
Usage: bash samples/multiplatform-app/plugins/cpp-component-service/configure.sh
...
configure_component_sample "${SAMPLE_ROOT}" "${SAMPLE_ROOT}/build"
