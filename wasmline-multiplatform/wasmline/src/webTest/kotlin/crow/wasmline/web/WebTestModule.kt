 ...
 *   (func (export "neg_f32") (param f32) (result f32) local.get 0 f32.neg)
 *   (func (export "neg_f64") (param f64) (result f64) local.get 0 f64.neg)
 *   (func (export "pair") (param i32) (result i32 i64) local.get 0 i64.const 42)
 *   (func (export "void") (param i32) local.get 0 drop)
 *   (func (export "trap") unreachable)
 *   (func (export "call_host") (param i32 i32) (result i32) local.get 0 local.get 1 call $host_add)
 *   (memory (export "memory") 1)
 *   (global (export "answer") i32 (i32.const 7)))
 * ```
 *
 * Date: 2026-08-25
...
internal object WebTestModule {
    ...
    fun bytes(): ByteArray = intArrayOf(
        ...
        ,
