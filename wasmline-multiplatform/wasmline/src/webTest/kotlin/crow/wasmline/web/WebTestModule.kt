...
internal object WebTestModule {
    ...
    fun bytes(): ByteArray = intArrayOf(
        ...
        // Type section: (i32, i32) -> i32 and (i64, i64) -> i64
        0x01, 0x0D, 0x02,
        0x60, 0x02, 0x7F, 0x7F, 0x01, 0x7F,
        0x60, 0x02, 0x7E, 0x7E, 0x01, 0x7E,
        // Import section: env.host_add (type 0)
        0x02, 0x10, 0x01,
        0x03, 0x65, 0x6E, 0x76,
        0x08, 0x68, 0x6F, 0x73, 0x74, 0x5F, 0x61, 0x64, 0x64,
        0x00, 0x00,
        // Function section: add (type 0), add64 (type 1), call_host (type 0)
        0x03, 0x04, 0x03, 0x00, 0x01, 0x00,
        // Memory section: min 1 page
        0x05, 0x03, 0x01, 0x00, 0x01,
        // Export section: add, add64, call_host, memory
        0x07, 0x24, 0x04,
