...
class NativeTypedComponentStringInputHostImportIntegrationTest {
    ...
    fun stringInputHostImportRoundTripsThroughTheJniRegistry() {
        ...
        try {
            ...
            try {
                ...
                assertEquals(
                    listOf(WasmlineComponentValue.S32(5)),
    ...
    private fun stringHostRegistry(): WasmlineComponentHostRegistry {
        val interfaceId = WasmlineComponentInterfaceId.of("example:host/string-api")
        val functionId = WasmlineComponentFunctionId.of(interfaceId, "length")
        return WasmlineComponentHostRegistry.builder()
            .register(
                ...
                WasmlineComponentHostAdapter { arguments ->
                    ...
                    WasmlineCallResult.Success(listOf(WasmlineComponentValue.S32(value.length)))
                },
            )
            .build()
    }
