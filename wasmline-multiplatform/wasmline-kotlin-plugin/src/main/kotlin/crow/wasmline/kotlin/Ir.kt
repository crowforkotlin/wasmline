...
/** Returns a string as specified by WasmlineFunction.signature. */
...
/** Returns a string as specified by Wasmline.id. */
...
internal fun IrBuilderWithScope.irKClass(containerClass: IrClass): IrClassReferenceImpl = IrClassReferenceImpl(
    startOffset = startOffset,
    endOffset = endOffset,
...
internal fun IrBuilderWithScope.irImplicitCoercionToUnit(expression: IrExpression): IrTypeOperatorCall = IrTypeOperatorCallImpl(
    startOffset = startOffset,
    endOffset = endOffset,
    type = context.irBuiltIns.unitType,
...
fun getOrCreateCompanion(enclosing: IrClass, irPluginContext: IrPluginContext): IrClass {
    ...
    irPluginContext.finderForBuiltins().findClass(StandardClassIds.Any)
    val finder = irPluginContext.finderForBuiltins()
    val anyType = finder.findClass(StandardClassIds.Any)!!
