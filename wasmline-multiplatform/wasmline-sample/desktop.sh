...
./gradlew wasmline-cli:run --args="build -i ../wasmline-sample/plugin/build/compileSync/wasmWasi/main/productionLibrary/optimized/wasmline-multiplatform-wasmline-sample-plugin.wasm -wt build/wasmline/wasmtime/wasmtime-v43.0.2-x86_64-linux --key build/wasmline/keys/ed25519_private.key"
