...
```shell
./gradlew :wasmline-cli:run --args="compile -i ../wasmline-sample/plugin/build/compileSync/wasmWasi/main/productionLibrary/optimized/plugin.wasm -wt build/wasmline/wasmtime/wasmtime-v41.0.1-aarch64-macos -n manga"
```

## compile with custom product name and version

```shell
./gradlew :wasmline-cli:run --args="compile -i ../wasmline-sample/plugin/build/compileSync/wasmWasi/main/productionLibrary/optimized/plugin.wasm -wt build/wasmline/wasmtime/wasmtime-v41.0.1-aarch64-macos -n manga --version 1.2.0"
```
...
```shell
./gradlew :wasmline-cli:run --args="compile -i ../wasmline-sample/plugin/build/compileSync/wasmWasi/main/productionLibrary/optimized/plugin.wasm -wt build/wasmline/wasmtime/wasmtime-v41.0.1-aarch64-macos -o build/wasmline/output -n manga --version 1.0.0"
```
