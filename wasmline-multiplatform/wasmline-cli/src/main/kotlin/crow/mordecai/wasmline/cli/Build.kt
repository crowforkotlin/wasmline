...
import crow.mordecai.wasmline.cli.extensions.baseJson
...
class Build : CliktCommand(name = "build") {
    ...
    override fun run() {
        ...
        val wasmtimeExec = _root_ide_package_.crow.mordecai.wasmline.cli.Compile.findWasmtimeExecutable(wasmtimeDir)
