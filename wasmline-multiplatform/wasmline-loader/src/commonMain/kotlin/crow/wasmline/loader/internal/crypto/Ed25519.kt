...
import crow.wasmline.loader.internal.crypto.Curve25519.copyConditional
import okio.Buffer
...
internal object Ed25519 : SignatureAlgorithm {
     ...
     */
    private class XYZT(val xyz: XYZ = XYZ(), val t: LongArray = LongArray(Field25519.LIMB_CNT)) {
        constructor(partialXYZT: PartialXYZT) : this() {
            fromPartialXYZT(this, partialXYZT)
        }
    ...
    private fun mulAdd(s: ByteArray, a: ByteArray, b: ByteArray, c: ByteArray) {
        ...
        var s11: Long = c11 + a0 * b11 + a1 * b10 + a2 * b9 + a3 * b8 + a4 * b7 +
