 ...
 *
 * Package workflows currently target prepared local host-compatible artifacts
 * (`.wasm` for browser hosts, `.cwasm` / `.pwasm` for Wasmtime-based hosts),
 * so richer source types must be translated by the loader layer before they
 * reach the runtime bridge.
 */
