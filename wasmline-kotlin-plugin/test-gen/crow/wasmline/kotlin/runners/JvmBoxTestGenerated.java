...
@TestMetadata("/home/crowf/develop/github/wasmline/wasmline-kotlin-plugin/testData/box")
@TestDataPath("$PROJECT_ROOT")
public class JvmBoxTestGenerated extends AbstractJvmBoxTest {
  private void run(String fileName) {
    runTest("/home/crowf/develop/github/wasmline/wasmline-kotlin-plugin/testData/box/" + fileName);
  }
  ...
  public void testAllFilesPresentInBox() {
    KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("/home/crowf/develop/github/wasmline/wasmline-kotlin-plugin/testData/box"), Pattern.compile("^(.+)\\.kt$"), null, true);
  }
}
